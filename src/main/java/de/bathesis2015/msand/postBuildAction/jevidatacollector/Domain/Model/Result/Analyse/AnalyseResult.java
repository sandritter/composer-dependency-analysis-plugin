 ...
 * 
 * AnalyseResult.java
 * This class summarizes the version analysis of integration dependencies.
 * The {@link AnalyseResult} object holds a list of {@link DependencyResult} objects,
 * the main component, which was analyzed and a {@link BuildData} object, that holds build specific information
 *
...
public class AnalyseResult extends ArrayList<DependencyResult> implements Serializable{
	...
	public String getResolverUrl(){
		String url = buildData.getJenkinsUrl()+ "job/" + buildData.getJobName() +"/"+ Integer.toString(buildData.getNumber()) + "/"+ DependentComponentResolver.SUB_URL;
		return url;
	}
	...
	/**
	 * get percentage of installed components, which are not tested in latest version
