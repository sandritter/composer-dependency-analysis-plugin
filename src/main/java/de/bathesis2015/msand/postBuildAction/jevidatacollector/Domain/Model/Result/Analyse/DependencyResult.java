 ...
 * The {@link DependencyResult} object holds the information about the analysis of an installed component. 
 *
...
public class DependencyResult implements Serializable{
	...
	/**
	 * installed component of a build, that has been reviewed {@link ComponentSummary}
	 */
 	private ComponentSummary analyseTarget = null;
 	
 	/**
 	 * build in which the analysis target was main component itself {@link BuildSummary}
 	 */
 	private BuildSummary relatedBuild = null;
 	
 	/**
 	 * list of dependencies of the analyseTarget which are not tested in latest version (list of {@link Disparity})
 	 */
	...
	public boolean hasWarnings(){
		if (disparities != null) return true; 
		return false;
	}
