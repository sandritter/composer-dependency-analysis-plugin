 ...
 * 
 * Disparity.java
 * A {@link Disparity} is created if a component version of the total set of installed components is having a different version
 * than the version of the same component of the subset of components, which are tested against each other.
 *
...
public class Disparity implements Serializable{ 
	...
	/**
	 * component in latest version that has been installed during a build {@link ComponentSummary}
	 */
